    ...
    if (n) {
        ...
        var a = {
                ...
                btnTpl: {
                    ...
                    close: '<button data-fancybox-close class="fancybox-button fancybox-button--close" title="{{CLOSE}}"> <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 2.21571L19.7843 0L11 8.78429L2.21571 0L0 2.21571L8.78429 11L0 19.7843L2.21571 22L11 13.2157L19.7843 22L22 19.7843L13.2157 11L22 2.21571Z" /></svg></button>',
                    smallBtn: '<button data-fancybox-close class="fancybox-close-small" title="{{CLOSE}}"></button>',
                    arrowLeft: '<button data-fancybox-prev class="fancybox-button fancybox-button--arrow_left" title="{{PREV}}"><svg width="30" height="22" viewBox="0 0 30 22" xmlns="http://www.w3.org/2000/svg"><path d="M10.7843 22L-9.61651e-07 11L10.7843 1.93704e-07L13 2.21572L4.21571 11L13 19.7843L10.7843 22Z"/><path d="M27.7843 22L17 11L27.7843 1.93704e-07L30 2.21572L21.2157 11L30 19.7843L27.7843 22Z"/></svg></button>',
                    arrowRight: '<button data-fancybox-next class="fancybox-button fancybox-button--arrow_right" title="{{NEXT}}"><svg width="30" height="22" viewBox="0 0 30 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19.2157 0L30 11L19.2157 22L17 19.7843L25.7843 11L17 2.21571L19.2157 0Z" fill="#F5CA18"/><path d="M2.21571 -3.87408e-07L13 11L2.21572 22L3.45919e-06 19.7843L8.78429 11L3.87408e-07 2.21571L2.21571 -3.87408e-07Z" fill="#F5CA18"/></svg></button>'
                },
                parentEl: "body",
                autoFocus: !1,
                backFocus: !0,
